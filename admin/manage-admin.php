            ...
            <br><br><br>
             ...
             <table class="tbl-full">
                ...
                <?php 
                    ...
                    $sql = "SELECT * FROM tbl_admin WHERE usertype = 'admin' ORDER BY id DESC";
                    //Execute the Query
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="<?php echo SITEURL; ?>admin/delete-admin.php?id=<?php echo $id; ?>" class="btn-danger" onclick="return confirm('Are you sure you want to delete this Admin?')">Delete</a>
                                        </td>
                                    </tr>
                                <?php
                            }
